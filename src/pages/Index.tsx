          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              <a href="tel:816-752-4944" 
                className="hidden lg:flex items-center gap-2 rounded-lg bg-blue-500 px-6 py-3 font-bold text transition-all transition-duration-1500ms hover:bg-blue-100 shadow-2g" 
