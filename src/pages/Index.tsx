        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div>
              ...
              <p><a href="tel:816-752-4944" onClick={(e)=>{e.preventDefault(); window.location.href = "mailto:mthomas@krs.insure";}} className="text-2xl font-bold text-white hover:text-red-500 transition">
                816-752-4944
              </a></p>
