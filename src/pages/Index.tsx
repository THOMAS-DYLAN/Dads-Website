import { Shield, Users, Heart, Clock, Search, Target, ShieldCheck, TrendingUp, TrendingUpIcon, Heart as HeartIcon, Umbrella, Phone, Menu, X, ChevronDown, ChevronRight, Star, ChevronLeft, MessageSquare, Mail, FileText } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-white/20 border-4 border-white flex items-center justify-center transition-all duration-300 hover:scale-110 hover:bg-white hover:shadow-lg cursor-pointer">
          ...
          <div className="flex justify-center mt-4">
            <Dialog>
              <DialogTrigger asChild>
                <button className="bg-blue-600 hover:bg-black-0 text-white font-bold px-6 py-3 rounded-lg transition transform hover:scale-105">
                License Here
                </button>
              </DialogTrigger>
