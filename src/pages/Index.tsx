...
const Index = () => {
  ...
  <div className="relative group">
    <button
      type="button"
      className="text-white hover:text-red-200 font-semibold transition flex items-center gap-1 py-2"
    >
      About
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div>
              ...
              <p><a href="tel:816-752-4944" className="mb-2 text-white">
                816-752-4944
              </a></p>
               <p><a href="mailto:mthomas@krs.insure" onClick={(e)=>{e.preventDefault(); window.location.href = "mailto:mthomas@krs.insure";}} className="mb-2 text-white">
                mthomas@krs.insure
              </a></p>
            </div>
          </div>
