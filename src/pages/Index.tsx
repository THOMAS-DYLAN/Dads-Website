          ...
          <div className="flex justify-center mt-4">
            <Dialog>
              <DialogTrigger asChild>
                <button className="bg-blue-600 hover:bg-purple-500 text-white font-bold px-6 py-3 rounded-lg transition transform hover:scale-105">
                License Here
                </button>
              </DialogTrigger>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div>
              ...
              <p><a href="tel:816-752-4944" className="text-2xl font-bold text-white hover:text-red-500 transition">
               ...
               <p><a href="mailto:mthomas@krs.insure" onClick={(e)=>{e.preventDefault(); window.location.href = "mailto:mthomas@krs.insure";}} className="text-2xl font-bold text-white hover:text-red-500 transition">
                mthomas@krs.insure
              </a></p>
            </div>
          </div>
